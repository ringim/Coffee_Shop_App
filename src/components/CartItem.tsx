...
const CartItem: React.FC<CartItemProps> = ({
  ...
  // Check if any price has a quantity greater than 0
  const hasItems = prices.some((price: any) => price.quantity > 0);

  // If there are no items, return null to not render anything
  if (!hasItems) {
    return null; // This will prevent rendering the CartItem if no quantities are left
  }
  ...
  return (
    <View>
        { prices.length != 1 ? (
            ...
            /* This is used for items with only a multiple sizes in the prices array. */
            <LinearGradient 
            start={{x:0, y:0}} 
            end={{x:1, y:0}}
            ...
            /* This is used for items with only a single size in the prices array. */
                ...
                > 
                  ...
                  {/* Combine Title and Subtitle in a Single Container */}
